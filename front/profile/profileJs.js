...
const profiles = {
  sieun: {
    ...
    comments: [
      ...
      '제 기술 스택과 자세한 내용은 <a href="https://ssieun.notion.site/275f43cf05084cd485bd1ca295d194eb?pvs=4">여기에</a> 있어요 🐣',
      "<br>",
      "멋있는 개발자가 되는 그날까지... 👊",
      '<a href="https://velog.io/@sieuno3o">블로그 주소</a>',
    ],
    time: "3:22",
  },
  yeeun: {
    ...
    comments: [
      ...
      "잘부탁드려요! (_ _)",
      '<a href="https://velog.io/@xenddy/posts">블로그 주소</a>',
    ],
    time: "1:23",
  },
  Hyosang: {
    ...
    comments: [
      ...
      '<a href="https://velog.io/@powerbattery/">블로그 주소</a>',
    ],
    time: "5:7",
  },
  Jonghyun: {
